...
def validate():
    ...
    val_dir = "D:/Productivity/github/mygo-9517/archive/balanced/test"
    ...
    model.load_state_dict(torch.load("vgg16_model_Aerial_Landscapeswss.pth", map_location=device))
